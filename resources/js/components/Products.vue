                        ...
                        <div class="row">
                            <div class="col-8">
                                    <div class="row">
                                      ...
                                      <div class="col">
                                        <h4>{{ store_name }}</h4> 
                                        <p v-if="seller.user_tel">Tel: {{ this.seller.user_mobile }}</p> 
                                        <p v-if="seller.user_mobile">Mobile: {{ this.seller.user_mobile }}</p> 
                                        <p v-if="seller.email">Email: {{ this.seller.email }}</p> 
                                      </div>
